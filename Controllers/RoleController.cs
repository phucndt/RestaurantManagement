...
namespace RestaurantManagement.Controllers
{
    public class RoleController : Controller
    {
        ...
        public RoleController(RestaurantManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Role != null ? 
                          ...
                          Problem("Entity set 'RestaurantManagementContext.Role'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestaurantManagementContext.Role'  is null.");
            }
            var role = await _context.Role.FindAsync(id);
            if (role != null)
            {
