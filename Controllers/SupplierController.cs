...
namespace RestaurantManagement.Controllers
{
    public class SupplierController : Controller
    {
        ...
        public SupplierController(RestaurantManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Supplier != null ? 
                          ...
                          Problem("Entity set 'RestaurantManagementContext.Supplier'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestaurantManagementContext.Supplier'  is null.");
            }
            var supplier = await _context.Supplier.FindAsync(id);
            if (supplier != null)
            {
