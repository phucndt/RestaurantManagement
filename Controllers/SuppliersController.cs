...
namespace RestaurantManagement.Controllers
{
    ...
    {
        private readonly MvcSupplierContext _context;

        public SuppliersController(MvcSupplierContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcSupplierContext.Supplier'  is null.");
            }
            var supplier = await _context.Supplier.FindAsync(id);
            if (supplier != null)
            {
