...
namespace RestaurantManagement.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var mvcOrderContext = _context.Order.Include(o => o.User);
            return View(await mvcOrderContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderId,UserId,OrderDate,TotalAmount,Status")] Order order)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Set<User>(), "UserId", "Password", order.UserId);
            return View(order);
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcOrderContext.Order'  is null.");
            }
            var order = await _context.Order.FindAsync(id);
            if (order != null)
            {
